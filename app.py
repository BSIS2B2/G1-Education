...
st.markdown(
    ...
    div[role="dialog"] {{
        background-color: {bg_color} !important;
        border: 1px solid {accent_color}4d !important;
        border-radius: 20px !important;
        box-shadow: 0 10px 40px rgba(0,0,0,0.5) !important;
    }}
    div[role="dialog"] h2 {{ color: {accent_color} !important; font-weight: 700 !important; }}
    div[role="dialog"] p {{ color: {text_color} !important; }}
    ...
    div[data-testid="stNotification"] svg {{ fill: {accent_color} !important; }}
